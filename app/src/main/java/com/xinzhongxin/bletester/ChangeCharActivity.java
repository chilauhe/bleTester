...
public class ChangeCharActivity extends Activity implements OnClickListener {
        ...
        public void onReceive(Context arg0, Intent intent) {
            ...
            if (BleService.ACTION_DATA_AVAILABLE.equals(action)) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        notify_result.setText(text_string);
    ...
    private void init() {
        ...
        notify_result = (TextView) findViewById(R.id.et_notify_resualt);
        notify_result.setMovementMethod(new ScrollingMovementMethod());
        ...
        save_result.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                saveResualt(notify_result.getText().toString());
            }
        });
    }
